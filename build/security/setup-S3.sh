...
curl -sSL https://raw.githubusercontent.com/HortonworksUniversity/Operations-Labs/master/build/security/CentOS-Base.repo.7.4.1708-S3 > /etc/yum.repos.d/CentOS-Base.repo
yum clean all
yum makecache
yum -y -q install git epel-release ntp screen mysql-connector-java jq python-configobj pip
...
curl -sSL https://raw.githubusercontent.com/HortonworksUniversity/Operations-Labs/master/build/security/install-ambari-bootstrap.sh | bash
