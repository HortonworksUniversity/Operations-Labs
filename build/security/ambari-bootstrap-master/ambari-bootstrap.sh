...
#
# source at http://github.com/HortonworksUniversity/Ops_Labs/1.1.0/build/security/ambari-bootstrap
#
# Download and run as root or with sudo. Or alternatively:
#   curl -sSL https://raw.githubusercontent.com/HortonworksUniversity/Ops_Labs/1.1.0/build/security/ambari-bootstrap/master/ambari-bootstrap.sh | sudo -E sh
#
...
case "${lsb_dist}" in
    ...
    case "${lsb_dist_release}" in
        ...
        (
            ...
            yum install -y -q curl ntp openssl python zlib wget unzip openssh-clients-7.4p1-13.el7_4
