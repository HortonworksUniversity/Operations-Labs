...
curl -sSL https://raw.githubusercontent.com/HortonworksUniversity/Ops_Labs/1.1.0/build/security/ambari-bootstrap/master/providers/growroot.sh | sudo bash; sudo reboot
EOF
